"""
    Zwischenstand als Nr.1 gesichert
    Hier finde ich leicht den Teil mit den Scrollbar
    Scrollbars funken etwas anders in Tkinter als in Qt
...
private_inp.grid(ipadx=3, ipady=3)
...
status_bar.grid(row=100, sticky=tk.W + tk.E, ipadx=3, ipady=3)
...
def save():
    ...
    filename = f'{category} - {subject}.txt'   # little creepy filename, better ad date/time ;)
